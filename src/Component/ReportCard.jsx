      ...
      <div className="flex flex-wrap items-center gap-x-3 gap-y-1 text-[11px] sm:text-[12px] font-medium text-slate-400">
        ...
        <div className="flex flex-1 items-center justify-end gap-3 min-w-fit">
          ...
          <div className="flex items-center gap-1 shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-3 h-3 sm:w-3.5 sm:h-3.5 text-slate-400">
            ...
            <span className="text-slate-500 whitespace-nowrap">{createdAt}</span>
          </div>
        </div>
      </div>
    </div>
